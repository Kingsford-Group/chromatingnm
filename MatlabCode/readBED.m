function [ chrom, starts, ends, name, scores, strand, reads, post, qvalue ] = readBED( filename, split2mat, outputpath )
%READBED parse bed files and save data to a mat file
